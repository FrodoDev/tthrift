...
var _ = trpc.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  TResponse twoWay(TRequest req)")
  fmt.Fprintln(os.Stderr, "  void oneWay(TRequest req)")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := trpc.NewTServiceClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "twoWay":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "TwoWay requires 1 args")
      flag.Usage()
    }
    arg6 := flag.Arg(1)
    ...
    argvalue0 := trpc.NewTRequest()
    err11 := argvalue0.Read(context.Background(), jsProt10)
    if err11 != nil {
      Usage()
      return
    }
    value0 := trpc.TRequest(argvalue0)
    fmt.Print(client.TwoWay(context.Background(), value0))
    fmt.Print("\n")
    break
  case "oneWay":
    if flag.NArg() - 1 != 1 {
      fmt.Fprintln(os.Stderr, "OneWay requires 1 args")
      flag.Usage()
    }
    arg12 := flag.Arg(1)
    ...
    value0 := trpc.TRequest(argvalue0)
    fmt.Print(client.OneWay(context.Background(), value0))
    fmt.Print("\n")
    break
  case "":
    Usage()
